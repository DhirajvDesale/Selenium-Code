...
public class RemoveDuplicateUsingTreeSet {
	...
	public static void main(String[] args) {
		...
		//avoid dublicate using treeset the order or insertion will go as per ascending order
		TreeSet<String> s1=new TreeSet<String>();
		//we are getting text of webelement from list and adding them in tree set 
